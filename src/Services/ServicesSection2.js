    ...
    <div className="lg:!mx-40 lg:items-center lg:!my-28 mt-24">
      <div className="grid lg:grid-cols-2 px-4">
        <div className="order-2 lg:order-1 grid lg:content-center justify-center lg:justify-left lg:justify-items-left">
          <h3 style={{textShadow: '1px -1px white'}} className="services-primary-text lg:w-9/12 font-semibold text-[#3f3350] mb-4 lg:text-4xl lg:mt-0 text-center lg:text-left -mt-10 pt-3 from-70% relative z-50 bg-gradient-to-t from-white">
          ...
          {/* Modal btn */}
          <button onClick={() => setOpenModal(true)} className="Modal-btn lg:mx-[unset] mx-auto my-auto lg:mr-auto !mt-14">
            <div className="flex gap-2 justify-center">
              <span>Start Now </span><img className="rocket" src={Rocket} alt="" />
            </div>
          </button>
