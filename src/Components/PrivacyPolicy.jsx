    ...
    <>
      ...
      <div data-custom-class="body">
            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">March 23, 2024</bdt>
                </span>
              </span>
            </strong>
          </span>
            ...
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">
                  The Blank Technologies Limited
                  <bdt className="block-component" />
                </bdt>{" "}
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">info@blank.ng</bdt>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          ...
          <a
            data-custom-class="link"
            href="https://app.termly.io/notify/b06b09d8-1146-415e-a647-0d78fbf2ae94"
                                                    ...
                                                    >
                                                      <span data-custom-class="body_text">
                                                        ...
                                                        >
                                                          <bdt className="question">
                                                            <a
                                                              href="https://paystack.com/privacy/merchant#:~:text=Paystack%20does%20not%20sell%2C%20trade"
                                                              target="_blank"
                                                              data-custom-class="link"
                                                            >
                                                              https://paystack.com/privacy/merchant#:~:text=Paystack%20does%20not%20sell%2C%20trade
                                                            </a>
                                                                      ...
                                                                      <span data-custom-class="body_text">
                                                                        ...
                                                                        >
                                                                          ...
                                                                          >
                                                                            <span data-custom-class="body_text">
                                                                              <bdt className="question">
                                                                                https://sudo.africa/legal/privacy-policy
                                                                              </bdt>
                                                                            </span>
                                                                            <span data-custom-class="body_text">
                                                                              <span
