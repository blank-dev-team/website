      ...
      <div className="lg:mt-20 lg:mb-20">
        <div className="grid lg:grid-cols-2 md:mx-10 lg:mx-40">
          <div className="text-side order-2 lg:order-1 lg:text-left lg:!mt-0 container__text-box b-1 text-center">
            <h3 style={{textShadow: '1px -1px white'}} className="text-[1.6rem] text-[#3f3d56]
            ...
            {/* Modal btn */}
            <button onClick={() => setOpenModal(true)} className="Modal-btn lg:mr-auto !inline-flex items-center justify-center gap-2">
             <span> Get Now </span>
